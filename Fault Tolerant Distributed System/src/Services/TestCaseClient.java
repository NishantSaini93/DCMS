...
public class TestCaseClient extends Thread{
	...
	public void run() {
		FrontEndImplementation beginserver = null;
		String emptystring[] = null;
		try {
			ORB objectorb = ORB.init(emptystring, null);
			...
			String nameofserver = "FrontEnd"; 
			beginserver = FrontEndImplementationHelper.narrow(newreferencethere.resolve_str(nameofserver));
		...
		try {
			...
			if (isSignedIn) {
				...
				String recordData;
				recordData = beginserver.getRecordCounts(this.managerID);
